...
class AppCartHistDet1 extends StatefulWidget {
  ...
  AppCartHistDet1({Key key, @required this.pAcctFullName  }) : super(key: key);


  @override
  _AppCartHistDet1State createState() => _AppCartHistDet1State(pAcctFullName);
}
...
class _AppCartHistDet1State extends State<AppCartHistDet1> {

  String vAcctFullName;

  _AppCartHistDet1State (this.vAcctFullName);
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Orders History with Confirmed Date"),
        centerTitle: false,
      ),
      /*body: new Center(
        child: new Text(
              ...
              title: new Row (
                children: <Widget>[
                 ...
                 /* new GestureDetector(
                  ...
                  Text('     Order Date2: ${df.format(group['confirmedDate'])}',
                    ),
