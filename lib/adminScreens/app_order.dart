...
import 'package:flutter_girlies_store/adminScreens/app_orderDetail.dart';
...
class AppOrder extends StatefulWidget {
  @override
  _AppOrderState createState() => _AppOrderState();
}
...
class _AppOrderState extends State<AppOrder> {
              ...
              onTap: () {
               // Navigator.of(context).pop();
                Navigator.of(context).push(new CupertinoPageRoute(
                    builder: (context) => AppOrderDetail(pAcctFullName: group['acctFullName'], pConfirmedDate : group['confirmedDate'])));
